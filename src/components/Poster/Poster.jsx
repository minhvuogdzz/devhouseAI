...
const ServiceCard = ({ title, desc, icon, borderColor }) => (
  <div 
    className="bg-slate-900/60 backdrop-blur-md border border-white/10 p-4 w-full rounded-r-2xl rounded-l-sm border-l-4 transition-transform hover:translate-x-2 duration-300 flex items-center gap-4"
      ...
      <div className="w-full h-full bg-[radial-gradient(circle_at_top_left,#0c4a6e_0%,#020617_100%)] relative border border-sky-400/20 flex flex-col lg:flex-row">
        ...
        <div className="relative z-20 w-full h-full flex flex-col lg:flex-row p-6 lg:p-16 gap-10 lg:gap-0">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            {/* Danh sách dịch vụ - Dùng Grid chia 2 cột trên PC */}
            ...
            <div className="mt-8 lg:mt-10 flex items-center space-x-3">
